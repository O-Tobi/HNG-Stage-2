import { ArrowDown, HorizontalLine, ProgressContainer } from "../utils/assets";
      ...
      <div className="flex bg-transparent md:bg-ticketCenter md:border-[1px] border-borderColor md:rounded-[32px] md:p-[24px] md:gap-[32px] ">
        <div className="flex flex-col justify-center ">
          ...
          <div className="flex justify-center items-center flex-col md:flex-row w-[287px] h-[112px] md:w-full md:rounded-[24px] md:border-[1px] border-borderColor px-[48px] gap-[20px] md:gap-[32px] md:h-[48px] bg-ticketCenter">
            <button className="order-2 btn w-[287px] md:w-[214px] h-[48px] border-[1px] border-[#24A0B5] rounded-[8px] py-[12px] px-[24px] bg-transparent text-[16px] underline text-[#24A0B5]">
              Cancel
            </button>
            <button className="order-1 btn w-[287px] md:w-[214px] h-[48px] border-[1px] border-[#24A0B5] rounded-[8px] py-[12px] px-[24px] bg-[#24A0B5] text-[16px] underline text-white">
              Next
            </button>
          </div>
        </div>
