        ...
        <Form>
          <div>
              ...
              <div className="flex rounded-[24px] md:rounded-[16px] border-[1px] border-[#07373F] md:border-borderColor p-[16px] gap-[16px] bg-[#052228] w-[287px] h-[275px] md:h-[186px] md:w-[556px]">
                <div className="flex flex-wrap justify-between items-center gap-[24px]">
                  {[
                    ...
                    { id: 'vvip', label: 'VVIP ACCESS', price: '$150', left: '20 left!' },
                  ].map((ticket) => (
                    <div key={ticket.id} className="flex justify-between underline rounded-[12px] gap-[8px] p-[8px] border-[1px] border-[#07373F] md:border-borderColor  w-[242px] h-[65px]">
              ...
              <details className="dropdown w-[287px] md:w-full">
                ...
                <ul className="menu bg-background dropdown-content rounded-box z-[1] w-full p-2 shadow">
                  {[1, 2, 3, 4, 5].map((num) => (
                    <li key={num}>
                      <a
                        onClick={() => setFieldValue('numberOfTickets', num.toString())}
                      >
                        {num}
                      </a>
                    </li>
            ...
            <div className="flex justify-center items-center flex-col md:flex-row w-[287px] h-[112px] md:w-full md:rounded-[24px] md:border-[1px] border-borderColor px-[48px] gap-[20px] md:gap-[32px] md:h-[48px] bg-ticketCenter">
              <button type="button" className="order-2 btn w-[287px] md:w-[214px] h-[48px] border-[1px] border-[#24A0B5] rounded-[8px] py-[12px] px-[24px] bg-transparent text-[16px] underline text-[#24A0B5]">
                Cancel
              </button>
              <button onClick={handleNext} type="submit" className="order-1 btn w-[287px] md:w-[214px] h-[48px] border-[1px] border-[#24A0B5] rounded-[8px] py-[12px] px-[24px] bg-[#24A0B5] text-[16px] underline text-white">
                Next
              </button>
            </div>
          </div>
